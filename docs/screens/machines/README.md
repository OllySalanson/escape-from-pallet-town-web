...
once-per-save Ferryman barter, paid in materials and never in scrip.
...
320x240); the battle and the Ferryman's board are unchanged by this work.
...
| `ferryman-barter-1200x768.png` | HM06 on the barter table: goods in, no scrip, once |
