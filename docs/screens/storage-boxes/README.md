...
Brock's payment, the swap-partner offer, the loadout, the secure slot and a
...
(the stash, the loadout, Brock's payment) has a sort - as kept, species,
...
| paying Brock, every box at once | `workshop-pay-1200x768.png` | |
