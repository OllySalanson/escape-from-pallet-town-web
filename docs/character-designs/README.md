...
lab, with RAIDER MAYA at 16,20 cast as `lass`. Figures 1 to 5 are the same
...
| File | Shows |
| --- | --- |
| `0-route-1-in-game.png` | The whole screen: Maya as a lass, turned to face the player, with the challenge prompt up |
