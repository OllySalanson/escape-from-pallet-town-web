...
export class BattleScene extends Phaser.Scene {
  ...
  private createStatusBox(
    ...
    this.add.image(x + 72, y + height / 2, 'battle-hud').setDisplaySize(144, height).setDepth(5);
    this.add.text(x + 9, y + 7, combatant.pokemon.base.name.toUpperCase(), {
      fontFamily: BATTLE_FONT,
      fontSize: '14px',
      color: '#202020',
    }).setDepth(6);
    this.add.text(x + 111, y + 8, `:L${combatant.pokemon.level}`, {
      fontFamily: BATTLE_FONT,
      fontSize: '13px',
      color: '#202020',
    }).setDepth(6);
    this.add.text(x + 15, y + 25, 'HP:', {
      fontFamily: BATTLE_FONT,
      fontSize: '12px',
      color: '#202020',
    }).setDepth(6);
