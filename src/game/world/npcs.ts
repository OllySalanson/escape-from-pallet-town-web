...
export const WORLD_ENTITIES: readonly WorldEntity[] = [
  ...
  {
    id: 'floodplain-levels-fieldboard',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 114, y: 86 },
    facing: 'up',
    dialogLines: [
      'A FIELD BOARD - EIGHT ACRE, drained and named',
      'Named the year it was drained. Under water four winters since.',
    ],
  },
  {
    id: 'floodplain-levels-fenmere',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 124, y: 69 },
    facing: 'right',
    dialogLines: [
      'A MERE STONE - the fen ends and the wood begins',
      'Fen one side, wood the other. The wood was here first and is waiting.',
    ],
  },
  {
    id: 'floodplain-staithe-ropewalk',
    mapId: 'floodplain-relay',
    kind: 'npc',
    position: { x: 19, y: 108 },
    facing: 'down',
    design: 'old-man',
    dialogLines: [
      'A rope walk is a hundred yards of straight and nothing else, and this was the only hundred yards of straight in the parish.',
      'Now it is a lane between two hedges, and I still walk it.',
    ],
  },
  {
    id: 'floodplain-levels-turfstack',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 110, y: 97 },
    facing: 'down',
    dialogLines: [
      'A TURF STACK - cut, stood and left to dry',
      'Two summers to dry and one winter to burn. These have had four summers.',
    ],
  },
  {
    id: 'floodplain-levels-dykereeve',
    mapId: 'floodplain-relay',
    kind: 'npc',
    position: { x: 114, y: 51 },
    facing: 'left',
    design: 'bald-man',
    dialogLines: [
      'Every drain has a man who answers for it. I answered for these four.',
      'The engine stopped and the answer stopped with it.',
    ],
  },
  {
    id: 'floodplain-cider-graftboard',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 76, y: 39 },
    facing: 'down',
    dialogLines: [
      'A GRAFTING BOARD - what stands in each close',
      'Kingston Black in this one, and a row of crabs down the north side to set the fruit.',
    ],
  },
  {
    id: 'floodplain-cider-picker',
    mapId: 'floodplain-relay',
    kind: 'npc',
    position: { x: 87, y: 56 },
    facing: 'right',
    design: 'straw-hat',
    dialogLines: [
      'Shake the tree, pick it off the ground, and none of it is eaten - it all goes in the press.',
      'Bruised fruit makes better cider. That is the one thing this place taught me.',
    ],
  },
  {
    id: 'floodplain-beck-hearth',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 63, y: 29 },
    facing: 'up',
    dialogLines: [
      'A CHARCOAL HEARTH - a flat circle in the wood',
      'Burnt slow under turf for a week. The ring of it stays in the ground for a hundred years.',
    ],
  },
  {
    id: 'floodplain-cider-loadingstage',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 96, y: 35 },
    facing: 'right',
    dialogLines: [
      'A LOADING STAGE - the cut, and what went down it',
      'Barrels on, lime and coal off. The cut runs to the river and the river ran to everywhere.',
    ],
  },
  {
    id: 'floodplain-withy-rotation',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 86, y: 65 },
    facing: 'up',
    dialogLines: [
      'A BED BOARD - cut on a three-year turn',
      'One year in three, in the winter, in the water. The rods for hurdles and the tips for baskets.',
    ],
  },
  {
    id: 'floodplain-muds-tidepost',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 6, y: 112 },
    facing: 'up',
    dialogLines: [
      'A TIDE POST - and how much of it you can see',
      'All of it and you may cross. Half of it and you had better be halfway.',
    ],
  },
  {
    id: 'floodplain-saltings-marshman',
    mapId: 'floodplain-relay',
    kind: 'npc',
    position: { x: 29, y: 64 },
    facing: 'left',
    design: 'hiker',
    dialogLines: [
      'The marsh is grazing eight months and sea for four, and every creek on it is crossed in one place only.',
      'Learn the places or keep to the drove.',
    ],
  },
  {
    id: 'floodplain-hundred-gateway',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 53, y: 64 },
    facing: 'down',
    dialogLines: [
      'A GATEWAY - a gap in a bank with no gate in it',
      'The gate went for firewood the first winter. The gap is still the only way through.',
    ],
  },
  {
    id: 'floodplain-saltings-plank',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 16, y: 82 },
    facing: 'right',
    dialogLines: [
      'A SHEEP PLANK - one board over one creek',
      'A plank and a handrail, and the handrail went the way the gates went.',
    ],
  },
  {
    id: 'floodplain-levels-mole',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 107, y: 93 },
    facing: 'up',
    dialogLines: [
      'A MOLE DRAIN MARK - what is under this field',
      'A mole plough drew a tunnel four feet down every eight feet across. They lasted ten years and then the field drowned.',
    ],
  },
  {
    id: 'floodplain-muds-withymark',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 26, y: 122 },
    facing: 'up',
    dialogLines: [
      'A WITHY MARK - a bundle on a pole, stuck in the bar',
      'Put there by somebody who came back. That is all a mark on the sands ever means.',
    ],
  },
  {
    id: 'floodplain-kilns-coalbunker',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 109, y: 21 },
    facing: 'left',
    dialogLines: [
      'A COAL BUNKER - what the kilns ate',
      'A ton of coal to four of lime, and every ton of it came up the cut and over the tram.',
    ],
  },
  {
    id: 'floodplain-beck-springhead',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 67, y: 27 },
    facing: 'right',
    dialogLines: [
      'A SPRING HEAD - where the beck starts',
      'It comes out of the hill cold in August and warm in February, and it has never once stopped.',
    ],
  },
  {
    id: 'floodplain-levels-stanchbeam',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 99, y: 45 },
    facing: 'down',
    dialogLines: [
      'A STANCH - the beam that held the level up',
      'Drop the boards and the cut above holds a foot more water. Pull them and it runs. Nobody has pulled them.',
    ],
  },
  {
    id: 'floodplain-levels-fieldgauge',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 107, y: 48 },
    facing: 'up',
    dialogLines: [
      'A DIP WELL - how far down the water is today',
      'A hand below the grass in summer, a hand above it in winter. This year it has been above it since March.',
    ],
  },
  {
    id: 'floodplain-staithe-sailloft',
    mapId: 'floodplain-relay',
    kind: 'npc',
    position: { x: 5, y: 96 },
    facing: 'right',
    design: 'sailor',
    dialogLines: [
      'The loft over the yard was long enough to lay a whole mainsail out flat, and there is nothing else it could have been built for.',
      'It is a good dry roof and I sleep under it.',
    ],
  },
  {
    id: 'floodplain-levels-osierstool',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 108, y: 97 },
    facing: 'down',
    dialogLines: [
      'A STOOL - one willow, cut back for forty years',
      'Cut to the same knuckle every three winters until it looks like a fist. Miss three cuts and it is a tree.',
    ],
  },
  {
    id: 'floodplain-light-coalstore',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 108, y: 111 },
    facing: 'up',
    dialogLines: [
      'THE COAL STORE - what the light burned before the oil',
      'Two hundred tons hauled out along the point every autumn, for one fire on one night at a time.',
    ],
  },
  {
    id: 'floodplain-muds-gutwaymark',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 42, y: 118 },
    facing: 'right',
    dialogLines: [
      'A GUTWAY - the channel between two bars',
      'It empties last and fills first, and everybody who has been caught out here was caught at one.',
    ],
  },
  {
    id: 'floodplain-cider-cellarboard',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 80, y: 53 },
    facing: 'right',
    dialogLines: [
      'THE CELLAR - under the close, not under the house',
      'Cut into the bank because the bank is the coldest thing in the parish. The hatch is in the hedge, and it is shut.',
    ],
  },
  {
    id: 'floodplain-withy-boilinghouse',
    mapId: 'floodplain-relay',
    kind: 'sign',
    position: { x: 66, y: 76 },
    facing: 'up',
    dialogLines: [
      'A BOILING HOUSE - where the rods were stripped',
